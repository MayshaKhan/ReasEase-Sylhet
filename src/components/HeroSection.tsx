  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 to-gray-900/60">
        <img
          src="/image-uploads/d191584e-0741-4edb-8fda-3ad629483420.png"
          alt="Beautiful homes"
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-48">
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 animate-fade-in">
          Find Your Next <span className="text-orange-500">Home</span> —
          <br />
          Quickly, Safely, and Locally
        </h1>

        <p className="text-xl md:text-2xl text-gray-200 mb-8 animate-fade-in">
          Whether you're buying, renting, or selling, we bring trust and
          simplicity to your property journey.
        </p>
